...
public class HoloDrawable extends WheelDrawable {
    ...
    private void init() {
        ...
        mHoloBgPaint.setColor(mStyle.getBackgroundColor() != -1 ? mStyle.getBackgroundColor() : WheelConstants
                .WHEEL_SKIN_HOLO_BG);

        mHoloPaint = new Paint();
        mHoloPaint.setStrokeWidth(mStyle.getHoloBorderWidth() != -1 ? mStyle.getHoloBorderWidth() : 3);
        mHoloPaint.setColor(mStyle.getHoloBorderColor() != -1 ? mStyle.getHoloBorderColor() : WheelConstants
