...
private fun generateLayoutParamsSet(viewGroup: ViewGroup): ViewGroup.LayoutParams? {
    val parser = viewGroup.resources.getLayout(R.layout.book_cover)
    try {
...
fun <U : ViewGroup.LayoutParams> ViewGroup.flashScreens(
    ...
    @Suppress("UNCHECKED_CAST") val params1: U =
            (generateLayoutParamsSet(this@flashScreens) as U).apply(paramSetup)
