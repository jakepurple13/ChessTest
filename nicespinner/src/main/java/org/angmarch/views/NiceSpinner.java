...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(R.drawable.rounded_corners_list_view);
        textColor = typedArray.getColor(R.styleable.NiceSpinner_mainTextTint, getDefaultTextColor(context));
        setTextColor(textColor);

        listViewBackgroundColor = typedArray.getColor(R.styleable.NiceSpinner_backgroundColor, getResources().getColor(R.color.light_gray, null));
        listViewTextColor = typedArray.getColor(R.styleable.NiceSpinner_textTint, getDefaultTextColor(context));

        listView = new ListView(context);
        // Set the spinner's id into the listview to make it pretend to be the right parent in
        // onItemClick
        listView.setId(getId());
        listView.setDivider(getResources().getDrawable(R.drawable.divider_list, null));
        listView.setItemsCanFocus(true);
        listView.setDividerHeight(3);
        //listView.setBackgroundColor(Color.BLACK);
        //listView.setBackgroundResource(R.drawable.rounded_corners_list_view);
        ...
        //popupWindow.setBackgroundDrawable(getResources().getDrawable(R.drawable.rounded_corners_list_view, null));
    ...
    public <T> void attachDataSource(List<T> list) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, backgroundSelector,
                spinnerTextFormatter, listViewBackgroundColor);
